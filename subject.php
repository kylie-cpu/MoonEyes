<?php
  ...
  if ($_POST) {
    ...
    $insert_subject = "INSERT INTO subjects(subject_id, subject_name, address, phone_nums, lawyer, notes, modified_by, day_modified, vehicle_info, place_of_work, associates) 
    VALUES ('$subject_id', '$subject_name', '$address', '$phone_nums', '$lawyer_id', '$notes', '$modified_by' ,'$day_modified', '$vehicle_info', '$pow', '$associates')";
   ...
   if (!empty($lawyer_name) || !empty($lawyer_email)) {
      $insert_lawyer = "INSERT INTO lawyers(lawyer_id, lawyer_name, lawyer_email) 
      VALUES ('$lawyer_id', '$lawyer_name', '$lawyer_email')";
    ...
    <div id="content"class="content">
      ...
      <form action="subject.php" method="POST" class="subject-form">
        ...
        <div class="form-group">
          ...
          <textarea id="phone_numbers" name="phone_numbers" rows="4"></textarea>
        </div>

        <div class="form-group">
          <label for="associates">Associates:</label>
          <textarea id="associates" name="associates" rows="4"></textarea>
        </div>

        <div class="form-group">
          <label for="vehicle_info">Vehicle Information:</label>
          <textarea id="vehicle_info" name="vehicle_info" rows="4"></textarea>
        </div>
