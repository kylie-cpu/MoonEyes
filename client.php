<?php
  ...
  if ($_POST) {
    ...
    $insert_client = "INSERT INTO clients(client_id, client_name, email, address, phone_num, lawyer, notes, modified_by, day_modified) 
    VALUES ('$client_id', '$client_name', '$email', '$address', '$phone_num', '$lawyer_id', '$notes', '$modified_by' ,'$day_modified')";
